...
class Block(object):
    def __init__(
        ...
        if index < 0:
            ...
            return False
        if Shared.Defined(transactions) == False:
...
#        self.block_data_hash = block_data_hash
    ...
    # The second set of metadata, namely the difficulty, timestamp and nonce, relate to the
    # mining competition. The third piece of metadata is the Merkle Tree root, a data structure
